...
public class WebClientConfig {
    ...
    public WebClient webClientAutenticacion(WebClient.Builder builder){
        ...
        HttpClient httpClient =
                HttpClient.create().option(ChannelOption.CONNECT_TIMEOUT_MILLIS,10000).// timeout de conexion
                responseTimeout(Duration.ofSeconds(10)). //timeout lectura de toda la respuesta
